...
app = Ursina()
grass_texture = load_texture('image/grass_block.png')
stone_texture = load_texture('image/stone_block.png')
brick_texture = load_texture('image/brick_block.png')
dirt_texture = load_texture('image/dirt_block.png')
